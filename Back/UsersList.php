	                		...
	                		<a href="DeleteUser?render=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this Member?')" title="Delete this Member" class="btn btn-danger"><i class="fa fa-trash"></i></a>
							 ...
							 <?php
                               ...
                               <?php  
		                		...
		                		<a href="Freeze?render=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to Disable Transfer for this Member account?')" title="Disable Transfer this Member" class="btn btn-info"><i class="fa fa-ban"></i> Disable TRF</a>
                                <?php } else if($row['transfer'] == 'freeze') { ?>
                                <a href="unFreeze?render=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to Enable Transfer for this Member account?')" title="Enable Transfer this Member" class="btn btn-warning"><i class="fa fa-check-o"></i> Enable TRF</a>
                                <?php } ?>
								</td>
