...
<?php
    ...
    <section class="content-header" style="color:white;">
        <h1><b>
            <?php echo $return_count; ?> Active Members Identity
        </b></h1>
        <ol class="breadcrumb">
            <li><a href="dashboard" style="color:white;"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active" style="color:white;"><i class="fa fa-users"></i> Active Members Identity</li>
        </ol>
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><strong>Active Members Identity    <?php if( $return_count != 0 ) { ?>
                        Showing <?php echo $return_count; ?>  of <?php echo $return_count; ?> Active Members Identity<?php if($return_count != 1) { ?>s<?php } ?>
                        <?php } else { ?>
                            0 Active Members Identity
                        <?php } ?>
						</strong>
                    </h3>
...
<td><a href="#viewConfirmModal" data-toggle="modal" data-target="#viewConfirmModal<?php echo $row['id']; ?>"> <img src="../member/<?php echo $row['proof_id']; ?>" width="50"/></a>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
						        <h3 class="modal-title" id="myModalLabel"><b>User Indentity PreView</b></h3>
      </div>
      <div class="modal-body">
	  <p style="font-size:16px;"><img src="../member/<?php echo $row['proof_id']; ?>" width="100%"  style="height:auto;"></p>
      ...
      <div class="modal-footer">
	                		...
	                		<a href="BlockUser?render=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to Blocked This Member?')" title="Block This Member" class="btn btn-danger"><i class="fa fa-ban"></i></a>
