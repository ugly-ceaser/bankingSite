...
$cahser = mysqli_query($con, "select * from users where id='$mem_id'")or die(mysqli_error());
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
						        <h3 class="modal-title" id="myModalLabel"><b>Credit <span class="text-black"><?php echo $recek['name']; ?></span> <?php echo $rowacc['account_type']; ?> Account</b></h3>
      </div>
...
<p>
      ...
      <div class="modal-footer">
		<button class="btn btn-block btn-primary" name="update" onclick="return confirm('Are you sure you want to Confirm Deposit?')"> Credit <?php echo $recek['name']; ?> <?php echo $rowacc['account_type']; ?> Account</button>
