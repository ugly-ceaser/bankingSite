                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">    
								<table class="table table-bordered-bd-warning table-head-bg-warning table-bordered table-hover">
								    ...
								    <tbody>	
								    	<?php
									$return_query = mysqli_query($con, "select * from withdrawal where user='$session_id'")or die (mysqli_error());
									...
									?>
										<tr>
											...
											<td style="text-align:center;"><b><?php echo $return_row['description']; ?></b></td>
