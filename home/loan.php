...
$account_query = mysqli_query($con, "select * from accounts where user_id='$session_id'")or die(mysqli_error());
...
<ul class="navbar-nav topbar-nav ml-md-auto align-items-center"><li class="nav-item dropdown"><a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="javascript:void();" aria-expanded="false"> <img src="assets/img/profile/profile.png" alt="user-img" width="36px" style="width:36px;" class="img-circle" data-picture><span ><?php echo $row['name']; ?></span></span> </a><ul class="dropdown-menu dropdown-user"><li><div class="user-box"><div class="u-img"><img src="assets/img/profile/profile.png" alt="user" data-picture></div><div class="u-text"><h4><?php echo $row['name']; ?></h4><p class="text-muted"><?php echo $row['email']; ?></p></div></div></li><div class="dropdown-divider"></div><a class="dropdown-item" href="settings"><i class="fa la-user"></i> Profile</a><div class="dropdown-divider"></div><a class="dropdown-item" href="logout"><i class="fa la-power-off"></i> Logout</a></ul><!-- /.dropdown-user --></li></ul>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="card">
                        ...
                        <form id="loan" style="display:contents;">
						<div class="card-body" style="padding-top:7px;padding-bottom:5px;">
						    ...
						    <div class="form-group col-7">
						        ...
						        <select name="plan" data-loan="" id="plan" class="form-control" required="">
						            <option value="">Loan Plan</option><option value="sjkdi78328kekjkkdsjdskdns89d8h9dsussaloiasuajsio" data-min="1500" data-max="20000" data-per="20">Personal Plan</option><option value="ds7dsiuh382ioaskimoas98hj398u9asha7shasidh78h38732" data-min="5000" data-max="50000" data-per="25">Family Plan</option><option value="klska89382j09ws87saskash89ahjsa89328j732huininass7a8h32" data-min="10000" data-max="200000" data-per="28">Business Plan</option>						            
						        </select>
					        </div>
					        ...
					        <div class="form-group col-6">
						        ...
						        <input type="text" id="rate" placeholder="Rate..." class="form-control text-center font-weight-bold" value="0%" disabled="">
					        </div>
					        <div class="form-group col-6">
						        <label for="int">Interest*</label>
						        <input type="text" id="int" placeholder="Interest..." class="form-control text-center font-weight-bold" value="$0.00" disabled="">
					        </div>
					        <div class="form-group col-12">
						        <label for="dur">Periodity*</label>
						        <select id="dur" class="form-control text-center font-weight-bold" disabled="">
						...
						<div class="card-footer py-2" align="center">
						    <button class="btn btn-warning btn-sm" type="submit">Request <i class="fa la-check-circle"></i></button>
						</div>
						</form>
					</div>
                </div>
                        ...
                        <div class="card-body" style="max-height:300px;overflow-y:scroll;">
                            ...
                            <div class="table-responsive">    
								<table class="table table-bordered-bd-warning table-head-bg-warning table-bordered table-hover">
								    ...
								    <tbody>
								        	<?php
									$return_query = mysqli_query($con, "select * from loan where user_id='$session_id'")or die (mysqli_error());
										...
										$accounData = mysqli_query($con, "select * from accounts where id=$acc_id")or die(mysqli_error());
									...
									?>
										<tr>
									        ...
									        <td style="text-align:center;"><b>$<?php echo number_format($return_row['interest']); ?></b></td>
	        ...
	        <div class="modal-content">		
				...
				<div class="modal-body" style="min-height:unset;border-bottom:1px solid #dee2e6;padding-top:7px;padding-bottom:7px;">
					...
					<div class="form-group form-group-sm col-sm-6">
						...
						<input type="text" data-number="" name="tel" maxlength="11" id="tel" placeholder="Mobile Number..." class="form-control" required="">
					</div>
					<div class="form-group form-group-sm col-sm-6">
					...
					<div class="form-group form-group-sm col-sm-6">
						<label for="inc">Monthly Income*</label>
						<input type="text" data-amount="" data-min="10" name="inc" maxlength="8" id="inc" placeholder="Monthly Income..." class="form-control" required="">
					</div>
					<div class="form-group form-group-sm col-sm-6">
						<label for="com">Company <small>(Optional)</small></label>
						<input type="text" name="com" maxlength="50" id="com" placeholder="Company..." class="form-control">
					</div>
	              ...
	              <div class="form-group mb-0" align="center">
	                  <button class="btn btn-sm btn-warning" type="submit">Save <i class="la la-check-circle"></i></button>
	              </div>
	            </div>
	            </form>
