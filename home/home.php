	...
	?>
					...
					<?php } ?>
						...
						<div class="row">
								...
								<table class="table table-bordered-bd-warning table-head-bg-warning table-bordered table-hover">
									<thead>
										<tr>
											...
											<th scope="col" style="text-align:center;"><i class="fa la-bar-chart"></i></th>
								...
								<table class="table table-bordered-bd-warning table-head-bg-warning table-bordered table-hover">
								    ...
								    <tbody>
										<tr>
										    ...
										    <td style="text-align:center;"><b>1106721351<br><small>(USD Account)</small></b></td>
										    <td style="text-align:center;"><b>$200.00<br><small>(0.01168078BTC)</small></b></td>
										    <td style="text-align:center;">Bitcoin</td>
										    <td style="text-align:center;">Thu 10th Nov, 2022 <small>(04:06am)</small></td>
										    <td style="text-align:center;"><b class="text-danger"><i class="fa la-times"></i> Failed</b></td>
										    <td style="text-align:center;"><b class="btn btn-xs btn-danger"><i class="fa la-times-circle"></i> Failed</b></td>
										</tr>
										<tr>
										    <td style="text-align:center;">2</td>
										    <td style="text-align:center;"><b>1106721351<br><small>(USD Account)</small></b></td>
										    <td style="text-align:center;"><b>$200.00<br><small>(0.01173738BTC)</small></b></td>
										    <td style="text-align:center;">Bitcoin</td>
										    <td style="text-align:center;">Thu 10th Nov, 2022 <small>(04:01am)</small></td>
										    <td style="text-align:center;"><b class="text-danger"><i class="fa la-times"></i> Failed</b></td>
										    <td style="text-align:center;"><b class="btn btn-xs btn-danger"><i class="fa la-times-circle"></i> Failed</b></td>
										</tr>
									</tbody>
							...
							<div class="w-100 text-center">
							    <a href="crypto" class="btn btn-warning">See More <i class="la la-arrow-circle-right"></i></a>
							</div>
