...
<title>Domestic - Midspring Bank</title>
...
<div class="main-panel"><div class="content" style="min-height:81vh;padding-top:12px;" id="my-view">
        <div class="container-fluid">                
            <div class="row">
                ...
                <div class="col-12">
                    <h4 class="page-title text-warning mb-0" align="center"><i class="fa la-bank"></i> Domestic Transfer</h4>
                    <?php	if($row['status'] == 'freeze') { ?>
						<br>
                ...
                <div class="col-12 col-md-10 mx-auto">
                    <div class="card">
                        <div class="card-header py-2">
                            <h4 class="card-title" align="center"><i class="fa la-refresh"></i> Domestic Transfer</h4>
                            <p class="card-category mt-1" style="line-height:1;" align="center"><small>Process <b>Domestic Transfer</b> using the form below.<br>Fill in the necessary informations &amp; submit to recieve your <b>OTP</b> to process the transfer.</small></p>
                        </div>
                        <form id="transfer" style="display:contents;" class="non-files-form" aria-autocomplete="false" data-type="add-trans" data-sub-url="post" data-reset="yes" data-express="home" data-suc="Domestic Transfer Successful!" data-info-modal="show_otp" data-info="An OTP has been sent to your email!<br/><small>Please submit on the next page to complete your transfer.</small>" data-reset-dummy="add-trans" data-close-modal="dummy" autocomplete="off">
					    ...
					    <div class="card-body" style="padding-top:5px;padding-bottom:7px;border-top: 1px solid #ebedf2!important;">
					        ...
					        <div class="form-group col-md-4">
						        ...
						        <input type="text" name="bank" minlength="3" maxlength="100" id="abank" placeholder="Bank..." value="Midspring Bank" class="form-control" readonly="">
					        </div>
					        <div class="form-group col-md-4">
