...
<title>Wire Transfer - Midspring Bank</title>
...
<div class="main-panel"><div class="content" style="min-height:81vh;padding-top:12px;" id="my-view">
        <div class="container-fluid">                
            <div class="row">
                ...
                <div class="col-12">
                    <h4 class="page-title text-warning mb-0" align="center"><i class="fa la-refresh"></i> Wire Transfer</h4>
                    <p class="mb-4" align="center">Transfer from your <b>Fiat Account</b> to other local &amp; international accounts using the form below.</p>
                </div>

                <div class="col-12 col-md-10 mx-auto">
                    <div class="card">
                        <div class="card-header py-2">
                            <h4 class="card-title" align="center"><i class="fa la-refresh"></i> Wire Transfer</h4>
                            <p class="card-category mt-1" style="line-height:1;" align="center"><small>Process <b>Wire Transfer</b> using the form below.<br>Fill in the necessary informations &amp; submit to recieve your <b>OTP</b> to process the transfer.</small></p>
                        </div>
                        <form id="transfer" style="display:contents;" class="non-files-form" aria-autocomplete="false" data-type="add-trans" data-sub-url="post" data-reset="yes" data-express="home" data-suc="Wire transfer Successful!" data-info="An OTP has been sent to your email!<br/><small>Please submit on the next page to complete your transfer.</small>" data-info-modal="show_otp" data-reset-dummy="add-trans" data-close-modal="dummy" autocomplete="off">
					    ...
					    <div class="card-body" style="padding-top:5px;padding-bottom:7px;border-top: 1px solid #ebedf2!important;">
					        ...
					        <div class="form-group col-md-6">
						        ...
						        <input type="text" id="aname" minlength="3" maxlength="100" placeholder="Account Name..." name="name" class="form-control" required="">
					        </div>
					        <div class="form-group col-md-7">
						        <label for="anum">Account Number*</label>
						        <input type="tel" maxlength="30" id="anum" name="num" placeholder="Account Number..." data-number="" class="form-control" required="">
					        </div>
					        <div class="form-group col-md-5">
						        <label for="rout">Routing Number*</label>
						        <input type="tel" maxlength="30" id="rout" name="routing" placeholder="Routing Number..." data-number="" class="form-control" required="">
					        </div>
					    ...
					    <div class="card-body" style="padding-top:5px;padding-bottom:7px;border-top: 1px solid #ebedf2!important;">
					        ...
					        <div class="form-group col-md-5">
						        ...
						        <input type="text" maxlength="100" id="addr" name="addr" placeholder="Address..." class="form-control" required="">
					        </div>
					        <div class="form-group col-md-7">
						...
						<div class="card-footer py-2" align="center">
						    <button class="btn btn-warning btn-sm" type="submit">Transfer <i class="fa la-check-circle"></i></button>
						</div>
						</form>
					</div>
                </div>
	    ...
	    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">	
	        <div class="modal-content">		
	            <div class="modal-header bg-warning justify-content-center">
	                <h6 class="modal-title"><i class="fa la-info-circle"></i> OTP Authentication</h6>	
	            </div>	
