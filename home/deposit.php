            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="card">
                        ...
                        <form id="invest" style="display:contents;" autocomplete="off">
						...
						<div class="card-footer py-2" align="center">
						    <button class="btn btn-warning btn-sm" type="submit">Deposit <i class="fa la-check-circle"></i></button>
						</div>
						</form>
					</div>
                </div>
                        ...
                        <div class="card-body" style="max-height:300px;overflow-y:scroll;">
                            ...
                            <div class="table-responsive">    
								<table class="table table-bordered-bd-warning table-head-bg-warning table-bordered table-hover">
								    ...
								    <tbody>
									<?php
									$return_query = mysqli_query($con, "select * from deposits where user='$session_id'")or die (mysqli_error());
									...
									?>
										<tr>
											...
											Cancelled
											<?php } ?></b></td>
										    <td style="text-align:center;"><b class="btn btn-xs btn-danger"><i class="fa la-times-circle"></i></b></td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
