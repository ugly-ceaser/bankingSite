                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-4 pt-3" align="center">
                                                <img src="assets/img/profile/profile.png" style="border-radius: 50%;width: 120px;height:120px;" alt="" data-picture="">
                                                <form action="#edit-pic" id="edit-pics">
				                                    <div class="form-group">
							                            <input type="file" class="form-control input-pill" name="prop" required="">
						                            </div>
						                            <div class="form-group pt-0" align="center">
						                                <button type="submit" class="btn btn-warning btn-sm btn-round">Change</button>
						                            </div>
                                                </form>
                                        </div>
                                        <div class="col-12 col-md-8">
                                            <form action="#add-acct" id="edit-pro">
				                                <div class="form-group">
							                        <label for="aname">Full Name*</label>
							                        <input type="text" class="form-control input-pill" id="aname" placeholder="Full Name*" value="<?php echo $row['name']; ?>" disabled="">
						                        </div>
						                        <div class="form-group">
						                        ...
						                        <div class="form-group">
							                        ...
							                        <textarea class="form-control input-pill" id="addr" name="addr" placeholder="Address*" rows="1" required=""><?php echo $row['reg_country']; ?></textarea>
						                        </div>
						                        
						                     <div class="form-group">
							                        <label for="addr">Country*</label>    
						                 <select name="country" required class="form-control input-pill">
                                ...
                                <option value="Zimbabwe">Zimbabwe</option>
						                        ...
						                        <div class="form-group" align="center">
						                            <button type="submit" class="btn btn-warning btn-sm btn-round">Update Profile</button>
						                        </div>
						                    </form>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="nav-sec" role="tabpanel" aria-labelledby="nav-sec-tab">
							        ...
							        <form action="#edit-sec" id="edit-sec">
							            <div class="form-group">
						                ...
						                <div class="form-group">
							                 ...
							                 <input type="password" class="form-control input-pill" id="rpass" name="rpass" placeholder="Repeat Password*" required="">
						                        ...
						                        <div class="form-group" align="center">
						                            <button type="submit" class="btn btn-warning btn-sm btn-round">Update</button>
						                        </div>
						            </form>
						            </div>
                                </div>
